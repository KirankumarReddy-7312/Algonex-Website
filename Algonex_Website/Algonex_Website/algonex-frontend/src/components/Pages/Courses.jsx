...
import { Clock, Users, Award, BookOpen, Code, CheckCircle, Star, TrendingUp, Zap, Target, ChevronDown, Globe, Rocket, ArrowRight, Briefcase, GraduationCap, X } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            ...
            <button
              ...
              className="px-12 py-5 border-2 border-white text-white rounded-xl font-bold text-xl hover:bg-white hover:text-blue-600 transition-all"
            >
              Book Free Demo
            </button>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm">
            <p>© 2025 Algonex IT Solutions. All rights reserved.</p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden relative shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            {formStatus !== 'submitted' ? (
              <div className="p-8">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">Book a Free Demo</h3>
                <p className="text-gray-500 mb-8 text-sm">Our experts will get in touch with you shortly.</p>
                ...
                <form onSubmit={handleDemoSubmit} className="space-y-4 text-left">
                  ...
                  <button
                    ...
                    type="submit"
                    className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-blue-700 transition-all transform hover:scale-[1.02] shadow-lg disabled:opacity-70 mt-4"
                  >
